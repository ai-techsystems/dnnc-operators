...
inputs = [helper.make_tensor_value_info("0", TensorProto.FLOAT, (1, 1, 4, 6))]
outputs = [helper.make_tensor_value_info("1", TensorProto.FLOAT, (1, 4, 2, 3))]
nodes = []
nodes.append(helper.make_node("SpaceToDepth", ["0"], ["1"], blocksize=2))
