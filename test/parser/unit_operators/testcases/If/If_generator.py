...
sub_graph = helper.make_graph([helper.make_node("And", ["0", "2"], ["1"])], "graph", inputs, outputs)
nodes = []
nodes.append(helper.make_node("If", ["0"], ["1"], else_branch=sub_graph, then_branch=sub_graph))
