...
inputs = [helper.make_tensor_value_info("X", TensorProto.FLOAT, (2,3,4)),	helper.make_tensor_value_info("W", TensorProto.FLOAT, (2,3,4)),	helper.make_tensor_value_info("R", TensorProto.FLOAT, (2,3,4)),	helper.make_tensor_value_info("B", TensorProto.FLOAT, (2,3,4))]
outputs = [helper.make_tensor_value_info("Y",TensorProto.FLOAT,(1,2))]
nodes = []
nodes.append(helper.make_node("RNN",["X","W","R","B"],["","Y"]))
