...
inputs = [helper.make_tensor_value_info("a", TensorProto.FLOAT, (2,3,4)),	helper.make_tensor_value_info("a_scale", TensorProto.FLOAT, (2,3,4)),	helper.make_tensor_value_info("a_zero_point", TensorProto.FLOAT, (2,3,4)),	helper.make_tensor_value_info("b", TensorProto.FLOAT, (2,3,4)),	helper.make_tensor_value_info("b_scale", TensorProto.FLOAT, (2,3,4)),	helper.make_tensor_value_info("b_zero_point", TensorProto.FLOAT, (2,3,4)),	helper.make_tensor_value_info("y_scale", TensorProto.FLOAT, (2,3,4)),	helper.make_tensor_value_info("y_zero_point", TensorProto.FLOAT, (2,3,4))]
outputs = [helper.make_tensor_value_info("y", TensorProto.FLOAT, (2,3,4))]
nodes = []
nodes.append(helper.make_node("QLinearMatMul",["a", "a_scale", "a_zero_point", "b", "b_scale", "b_zero_point", "y_scale", "y_zero_point"],["y"],))
